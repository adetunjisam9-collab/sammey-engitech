    ...
    <section id="vision" className="py-24 px-6 relative overflow-hidden" style={{ background: "#030712" }}>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {visions.map((v, i) => (
            <div key={i} className="group p-8 rounded-2xl border border-white/10 bg-white/5 hover:border-teal-400/50 hover:bg-white/10 transition duration-300">
        ...
        <div className="mt-16 p-8 rounded-2xl border border-teal-400/20 text-center" style={{ background: "rgba(0,255,198,0.03)" }}>
